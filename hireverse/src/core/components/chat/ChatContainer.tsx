  ...
  return (
    <Box sx={{display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, 
                mb: 2, borderBottom: `${activeChat ? `1px solid ${colors.borderColour}` : "none"}`, 
      ...
      <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column", overflowY: "auto" }}>
        {activeChat ? <ChatMessages messages={messages} styles={{paddingLeft: !onBack ? 2 : 0}} /> : <Typography textAlign="center">Select a chat to start messaging.</Typography>}
      </Box>
